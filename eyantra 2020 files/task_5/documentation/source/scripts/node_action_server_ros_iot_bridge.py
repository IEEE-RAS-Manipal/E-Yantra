#!/usr/bin/env python
"""
Action Server for the ROS-IoT Bridge and integrates with Google Sheets.
"""
import json
import threading
import requests
...
def on_cancel(goal_handle):
    """
    Called when a Goal Cancel Request is send to the Action Server.

    :arg str goal_handle: The data of the goal to cancel.
    """
...
class RosIotBridgeActionServer(object):
    ...
    def mqtt_sub_callback(self, client, userdata, message):
        ...
        :arg str client: The action client.
        :arg str userdata: The data of the current user/action client.
        :arg str message: The message to be sent.
        """
    ...
    def on_goal(self, goal_handle):
        ...
        :arg str goal_handle: The received goal to process.
        """
    ...
    def process_goal(self, goal_handle):
        ...
        :arg str goal_handle: The goal to process.
        """
    ...
    def spreadsheet_push(self, goal_handle):
        """
        Converts *goal_handle* into a dictionary object using JSON
        and pushes it to the Google spreadsheet.

        :arg str goal_handle: The spreadsheet dictonary data to process and push.
        """
