...
class UR5One(object):
    ...
    def __init__(self):
        ...
        self.order_num = [] # List of finished orders
...
(
    'rosservice call /eyrc/vb/ur5/activate_vacuum_gripper/ur5_1 "activate_vacuum_gripper: false"'
        ...
        self.order_num.append(order["Order ID"])
    ...
    def controller(self):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                if curr_order and curr_order["Order ID"] not in self.order_num:
