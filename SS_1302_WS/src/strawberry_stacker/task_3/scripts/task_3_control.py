...
class StateMonitor:
    ...
    def __init__(self) -> None:
        ...
        self.gripper_state = None  # State of the gripper (setting dummy initial value)
...
if __name__ == "__main__":
    try:
        rospy.init_node("ss1302_task3_1", anonymous=True)  # Initialising node
        ...
        for i in setpoints[:]:
            ...
            if i == [3, 0, 3]:
                ...
                rospy.loginfo("Using approach setpoint: \033[96m[3, 0, 1]\033[0m")
                drone_control.drone_set_goal([3, 0, 1], 0.01)
                rospy.loginfo("Using approach setpoint: \033[96m[3, 0, 0.1]\033[0m")
            ...
            # Beginning placing procedure
                ...
                rospy.loginfo("\033[93mCommencing placement of package...\033[0m")
                # Using approach point for precision
                rospy.loginfo("Using approach setpoint: \033[96m[3, 3, 0.2]\033[0m")
