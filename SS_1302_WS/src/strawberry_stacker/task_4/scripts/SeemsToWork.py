    ...
    class DroneControl:
        ...
        def drone_package_pick(self, package_pos: list) -> None:
            ...
            while self.drone_monitor.current_state.armed:
                ...
                if ((aruco_cx in range(180, 220)) and (aruco_cy in range(180, 220)) and self.drone_monitor.current_pose.pose.position.z > 1.0) or ((aruco_cx in range(190, 210)) and (aruco_cy in range(330, 350)) and self.drone_monitor.current_pose.pose.position.z <= 1.0):
